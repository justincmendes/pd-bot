...
module.exports = {
  ...
  run: async function run(
    ...
    trackUsageMessage = fn.getMessageEmbed(
      trackUsageMessage,
      "Voice Channel Tracking: Help",
      trackEmbedColour
    );
    ...
    const showTrackedVoiceChannels = fn
      .getMessageEmbed(
    ...
    //see, edit (when edit, show see first then usage),
      ...
      do {
        ...
        const fieldToEditInstructions =
          "**__Which field do you want to edit?__**";
        const fieldToEditAdditionalMessage = await fn.voiceChannelArrayToString(
          bot,
          authorID,
          userSettings.voiceChannels
        );
        ...
        if (!continueEdit) {
          ...
          continueEdit = await fn.getUserConfirmation(
            ...
            continueEditMessage,
            forceSkip,
            `Voice Channel Tracking: Continue Editing?`,
            300000
          );
        }
    ...
    // Find channel they want to toggle it for, then toggle it on or off :)
      ...
      trackCommand === "reminder" ||
      trackCommand === "reminders" ||
      trackCommand === "remind" ||
      trackCommand === "remindme" ||
      trackCommand === "rem" ||
      trackCommand === "re" ||
      trackCommand === "r" ||
      trackCommand === "report" ||
      ...
      const success = await tr.setUserTrackingReportReminder(
        bot,
        message,
        PREFIX,
        timezoneOffset,
